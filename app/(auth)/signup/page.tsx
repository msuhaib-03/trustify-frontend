...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // SIGNUP API CALL - No token needed, backend generates token on login
  ...
  const handleGoogleLogin = () => {
    const googleAuthUrl = `https://accounts.google.com/o/oauth2/v2/auth?client_id=${GOOGLE_CLIENT_ID}&redirect_uri=${encodeURIComponent(GOOGLE_REDIRECT_URI)}&response_type=code&scope=email%20profile&access_type=offline&prompt=consent`
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center bg-gradient-to-br from-primary/10 via-background to-accent/10 p-12">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-md">
            Create your verified account and start trading safely with our secure escrow payments and real-time chat.
          </p>
        </motion.div>
      </div>
